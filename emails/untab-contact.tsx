          ...
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Section className="text-center">
              ...
              <Section className="mt-4">
                <Link href="https://untab.studio" className="text-[#cf3f99] text-[10px] mx-2 no-underline">Website</Link>
                <Link href="https://twitter.com/untab_studio" className="text-[#cf3f99] text-[10px] mx-2 no-underline">Twitter</Link>
                <Link href="https://instagram.com/untab_studio" className="text-[#cf3f99] text-[10px] mx-2 no-underline">Instagram</Link>
              </Section>
            </Section>
          </Container>
        </Body>
